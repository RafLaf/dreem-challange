...
random_grid = {
        'learning_rate': [0.01 * i for i in range(1, 4, 2)],
        'n_estimators': [200 * i for i in range(1, 4, 2)],
        'min_child_weight': [1],
        'gamma': [0.5, 1],
        'subsample': [0.6, 0.8],
